	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				blackfriday: {
					primary: 'hsl(var(--blackfriday-primary))',
					accent: 'hsl(var(--blackfriday-accent))',
					text: 'hsl(var(--blackfriday-text))',
					bg: 'hsl(var(--blackfriday-bg))',
					card: 'hsl(var(--blackfriday-card))'
				},
				fun: {
			...
			backgroundImage: {
				...
				'gradient-blackfriday': 'var(--gradient-blackfriday)',
			...
			boxShadow: {
				...
				'blackfriday': 'var(--shadow-blackfriday)',
				'fun': 'var(--shadow-fun)',
